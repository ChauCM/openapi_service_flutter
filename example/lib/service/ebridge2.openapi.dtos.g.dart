...
part of 'ebridge2.openapi.dtos.dart';
...
_ConversationApiDto _$ConversationApiDtoFromJson(Map<String, dynamic> json) =>
    _ConversationApiDto(
      ...
      lastMessageSentDate: json['lastMessageSentDate'] == null
          ? null
          : DateTime.parse(json['lastMessageSentDate'] as String),
      isDeleted: json['isDeleted'] as bool?,
      createdByUserId: json['createdByUserId'] as String?,
      createdDate: json['createdDate'] == null
          ? null
...
Map<String, dynamic> _$ConversationApiDtoToJson(_ConversationApiDto instance) =>
    <String, dynamic>{
      ...
      'lastMessageSentDate': instance.lastMessageSentDate?.toIso8601String(),
      'isDeleted': instance.isDeleted,
      'createdByUserId': instance.createdByUserId,
      'createdDate': instance.createdDate?.toIso8601String(),
      'lastUpdatedByUserId': instance.lastUpdatedByUserId,
...
_EnumObjectDto _$EnumObjectDtoFromJson(Map<String, dynamic> json) =>
    _EnumObjectDto(
      name: json['name'] as String,
...
Map<String, dynamic> _$EnumObjectDtoToJson(_EnumObjectDto instance) =>
    <String, dynamic>{
      'name': instance.name,
...
_InfantWellnessActivityDTODto _$InfantWellnessActivityDTODtoFromJson(
    ...
    _InfantWellnessActivityDTODto(
      ...
      activities: (json['activities'] as List<dynamic>?)
          ...
          .toList(),
      feedActivities: (json['feedActivities'] as List<dynamic>?)
          ?.map((e) => FeedActivityDto.fromJson(e as Map<String, dynamic>))
          .toList(),
      restAtivities: (json['restAtivities'] as List<dynamic>?)
          ?.map((e) => RestActivityDto.fromJson(e as Map<String, dynamic>))
          .toList(),
      poopActivities: (json['poopActivities'] as List<dynamic>?)
          ?.map((e) => PoopActivityDto.fromJson(e as Map<String, dynamic>))
          .toList(),
      hygieneActivities: (json['hygieneActivities'] as List<dynamic>?)
          ?.map((e) => HygieneActivityDto.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$InfantWellnessActivityDTODtoToJson(
    ...
    <String, dynamic>{
      ...
      'feedActivities': instance.feedActivities,
      'restAtivities': instance.restAtivities,
      'poopActivities': instance.poopActivities,
      'hygieneActivities': instance.hygieneActivities,
