...
part 'ebridge2.openapi.dtos.freezed.dart';
part 'ebridge2.openapi.dtos.g.dart';
...
sealed class ConversationApiDto with _$ConversationApiDto {
  factory ConversationApiDto({
    ...
    @JsonKey(name: 'unreadMessageCount') int? unreadMessageCount,
    @JsonKey(name: 'lastMessageSentDate') DateTime? lastMessageSentDate,
    @JsonKey(name: 'isDeleted') bool? isDeleted,
    @JsonKey(name: 'createdByUserId') String? createdByUserId,
    @JsonKey(name: 'createdDate') DateTime? createdDate,
    @JsonKey(name: 'lastUpdatedByUserId') String? lastUpdatedByUserId,
...
@freezed
sealed class EnumObjectDto with _$EnumObjectDto {
  factory EnumObjectDto({
    @JsonKey(name: 'name') required String name,
    @JsonKey(name: 'value') required int value,
    @JsonKey(name: 'description') required String description,
  }) = _EnumObjectDto;

  factory EnumObjectDto.fromJson(Map<String, dynamic> json) =>
      _$EnumObjectDtoFromJson(json);
}
...
sealed class InfantWellnessActivityDTODto with _$InfantWellnessActivityDTODto {
  factory InfantWellnessActivityDTODto({
    ...
    @JsonKey(name: 'feedActivities') List<FeedActivityDto>? feedActivities,
    @JsonKey(name: 'restAtivities') List<RestActivityDto>? restAtivities,
    @JsonKey(name: 'poopActivities') List<PoopActivityDto>? poopActivities,
    @JsonKey(name: 'hygieneActivities')
    List<HygieneActivityDto>? hygieneActivities,
