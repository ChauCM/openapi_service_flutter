...
import 'stepo_json_311.openapi.dtos.dart';

class StepoJson311ServiceConfig {
  const StepoJson311ServiceConfig({
    this.baseUrl = '',
...
class StepoJson311Service {
  StepoJson311Service(
    this._dio, {
    StepoJson311ServiceConfig? config,
  }) {
    final serviceConfig = config ?? StepoJson311ServiceConfig();
