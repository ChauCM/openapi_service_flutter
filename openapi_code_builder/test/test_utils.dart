...
/// Test utilities for OpenApiCodeBuilder tests
class TestUtils {
  /// Creates a default OpenApiCodeBuilder instance for testing
  static OpenApiCodeBuilder createDefaultBuilder() {
  ...
  static OpenApiCodeBuilder createCustomBuilder({
