...
import 'package:open_api_dart/src/v3/types.dart';
...
class APISchemaObject extends APIObject {
  ...
  void decode(KeyedArchive object) {
    ...
    final requiredList = object.decode("required") as List<String?>?;
    required = requiredList?.where((item) => item != null).cast<String>().toList();
