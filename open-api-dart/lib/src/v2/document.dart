...
import 'package:open_api_dart/src/v2/metadata.dart';
import 'package:open_api_dart/src/v2/parameter.dart';
import 'package:open_api_dart/src/v2/path.dart';
import 'package:open_api_dart/src/v2/response.dart';
import 'package:open_api_dart/src/v2/schema.dart';
import 'package:open_api_dart/src/v2/security.dart';
...
class APIDocument extends APIObject {
  ...
  Map<String, cast.Cast> get castMap => {
        "schemes": cast.List(cast.StringCast()),
        "consumes": cast.List(cast.StringCast()),
        "produces": cast.List(cast.StringCast()),
        "security": cast.List(
